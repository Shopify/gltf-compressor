...
export default function Confetti() {
  const gradientsTextureAtlas = useTexture("/gradients_texture_atlas.png");
  ...
  useFrame((state) => {
    confettiMaterial.uniforms.time.value = state.clock.elapsedTime;
  });
...
useTexture.preload("/gradients_texture_atlas.png");
